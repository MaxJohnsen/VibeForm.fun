...
export const RespondentPage = () => {
  ...
  if (!formId) {
    return (
      <div className="h-[100dvh] flex items-center justify-center p-4 bg-gradient-respondent">
  ...
  if (showWelcome && formInfo) {
    return (
      <div className="h-[100dvh] bg-gradient-respondent">
        <WelcomeScreen
  ...
  return (
    <div className="h-[100dvh] bg-gradient-respondent flex flex-col overflow-hidden">
